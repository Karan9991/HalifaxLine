...
import '../ui/screens/chat_screen.dart';
import '../ui/screens/settings_screen.dart';
import '../ui/screens/all_active_screen.dart'; // <-- add this

class AppRouter {
  static String initialRoute(AuthProvider auth) {
    if (auth.isLoggedIn) return HomeScreen.routeName;
    return AgeGateScreen.routeName;
  }
  ...
  static Route<dynamic> onGenerateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case SettingsScreen.routeName:
        return MaterialPageRoute(builder: (_) => const SettingsScreen());
      case AllActiveScreen.routeName: // <-- new
        return MaterialPageRoute(builder: (_) => const AllActiveScreen());
      default:
        return MaterialPageRoute(
          builder: (_) => const Scaffold(body: Center(child: Text('Route not found'))),
        );
